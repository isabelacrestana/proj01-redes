...
def cliente():
    ...
    # conecta ao servidor
    cliente.connect((server_ip, port))  #conecta o cliente ao servidor, passando o ip e a porta do servidor
    ...
    try:
        while True:
            ...
            if not msg: #se a mensagem for vazia, não envia nada
                continue  #evita enviar mensagens vazias, volta pro laço while True e espera nova entrada do usuário       
